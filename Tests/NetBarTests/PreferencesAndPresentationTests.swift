...
final class PreferencesAndPresentationTests: XCTestCase {
    ...
    func testDockIconVisibilityMapsHiddenToAccessoryPolicy() {
        XCTAssertEqual(DockIconVisibility.hidden.activationPolicy, .accessory)
        XCTAssertFalse(DockIconVisibility.hidden.isDockVisible)
        XCTAssertFalse(DockIconVisibility.hidden.boolValue)
    }

    func testDockIconVisibilityInitFromBool() {
        XCTAssertEqual(DockIconVisibility(showsDockIcon: true), .visible)
        XCTAssertEqual(DockIconVisibility(showsDockIcon: false), .hidden)
    }
    ...
    func testDockIconVisibilityIsCaseIterableWithExactlyTwoCases() {
        XCTAssertEqual(DockIconVisibility.allCases, [.visible, .hidden])
    }
    ...
    func testDockIconVisibilityLocalizedTitles() {
        ...
        XCTAssertEqual(DockIconVisibility.hidden.title(language: .simplifiedChinese), "隐藏 Dock 图标")
        XCTAssertEqual(DockIconVisibility.hidden.title(language: .english), "Hide Dock icon")
    }
    ...
    func testAppPreferencesDockVisibilityDerivesFromShowsDockIcon() {
        ...
        XCTAssertEqual(preferences2.dockIconVisibility, .hidden)
